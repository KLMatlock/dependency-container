...
from duty.callables import coverage, lazy, mkdocs, pytest, ruff, safety
...
def changelog(ctx: Context) -> None:
    ...
    raise NotImplementedError("Waiting to implement towncrier!")
...
def check_types(ctx: Context) -> None:
    ...
    Parameters:
        ctx: The context instance (passed automatically).
    """
    from pyright.cli import main as pyright

    ctx.run(
        pyright,
        args=[[]],
        title=pyprefix("Type-checking"),
        command=f"pyright {PY_SRC}",
    )
